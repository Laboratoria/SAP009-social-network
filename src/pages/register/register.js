...
export default () => {
  ...
  const registerScreen = `
    ...
    <form action="formulario-de-cadastro" id="form_register">
      ...
      <button type="button" id="button_register"> cadastrar </button>
  ...
  cadastro.addEventListener('click', (e) => {
    ...
    createUser(inputEmail.value, inputPassword.value)
      .then(() => {
        confirmationMessage.innerHTML = `OLÁ ${inputName.value}! <br> <strong> SEU CADASTRO FOI REALIZADO! 
         </strong><br> Agora, faça o <a href="/#login">LOGIN</a> para navegar!`;
      })
      .catch((error) => {
