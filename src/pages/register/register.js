...
export default () => {
  ...
  const confirmationMessage = registerContainer.querySelector(
  ...
  buttonRegister.addEventListener("click", (event) => {
    ...
    const inputConfirmPassword =
      registerContainer.querySelector("#confirm-password");

    // eslint-disable-next-line max-len
    const validationRegister = validateRegister(
      inputName.value,
      inputEmail.value,
      inputPassword.value,
      ...
      createUser(
        ...
        .then(() => {
          confirmationMessage.innerHTML =
            "CADASTRO REALIZADO COM SUCESSO! &#x2705 <br> Agora, faça o login para entrar!";
