...
async function criarUsuario(email, senha, nomeTutor, nomeCao) {
  ...
  await Jl(Za(db, "usuarios", auth.currentUser.uid), usuario);
}
async function logarGoogle() {
  await signInWithPopup(auth, provider);
  const usuario = await Kl(Za(db, "usuarios", auth.currentUser.uid));
  if (!usuario.exists()) {
    const usuarioGoogle = {
    ...
    await Jl(Za(db, "usuarios", auth.currentUser.uid), usuarioGoogle);
  }
}
const editarNomeCao = async (novoNomeCao) => {
  await Yl(Za(db, "usuarios", auth.currentUser.uid), {
    nomeCao: novoNomeCao
  });
};
...
const criarPost = async (textPost) => {
  ...
  const docRef = await Xl(Ja(db, "posts"), post);
  post.id = docRef.id;
  return post;
};
const obterPosts = async () => {
  const colecaoPosts = await zl(Ja(db, "posts"));
  const textos = [];
...
const obterNomeUsuario = async () => {
  const usuarioRef = await Kl(Za(db, "usuarios", auth.currentUser.uid));
  const usuario = {
...
const deletarPost = (postId) => {
  const postRef = Za(db, "posts", postId);
  Zl(postRef);
};
...
const ilustracaoRegistro = "" + new URL("good_dogg.b45a444e.png", import.meta.url).href;
const registro = () => {
  ...
  const template = `
        <div class="main">
            <div class="txt-entrar"> 
                ...
                <img src="${ilustracaoRegistro}" class="ilustracao-cadastro" alt="ilustra\xE7\xE3o-cadastro">
            </div>
  ...
  const template = `
        <div class="main">
            <div class="txt-novo-usuario"> 
                ...
                <img src="${ilustracaoLogin}" class="ilustracao-login" alt="ilustra\xE7\xE3o-login">
            </div>
            <div class="tela-principal">
                <div class="logo-tela">
...
const ilustracaoRedefinir = "" + new URL("dog_pop.57f64908.png", import.meta.url).href;
  ...
  const template = `
    <div class="main">
      <div class="txt-voltar">
        ...
        <img src="${ilustracaoRedefinir}" class="ilustracao-redefinir-senha" alt="ilustra\xE7\xE3o-redefinir-senha">
      </div>
      <div class="tela-principal">
...
const coracaoDeslike = "" + new URL("like-pata-3.3738f0cd.png", import.meta.url).href;
const coracaoPreenchido = "" + new URL("like-pata-2.cd5e5d65.png", import.meta.url).href;
const feed = async () => {
...
const devAna = "" + new URL("ana.a2995aba.png", import.meta.url).href;
const devPaola = "" + new URL("paola.ef428ad9.png", import.meta.url).href;
const devThai = "" + new URL("thai.188049e3.png", import.meta.url).href;
const tieta = "" + new URL("tieta.51bb1f8b.png", import.meta.url).href;
const juca = "" + new URL("juca.179875b6.png", import.meta.url).href;
const luigi = "" + new URL("luigi.c3374fee.png", import.meta.url).href;
const iconeLinkedin = "" + new URL("linkedin.3e907258.png", import.meta.url).href;
const iconeGitHub = "" + new URL("github.c0551dcc.png", import.meta.url).href;
const sobre = () => {
  const container = document.createElement("div");
  const template = `
        <div class="main">
