...
const obterPosts = async () => {
  const textos = [];
  const ordenarPost = ol(Ja(db, "posts"), dl("data", "desc"));
  const colecaoPosts = await zl(ordenarPost);
...
const ilustracaoLogo = "/assets/logo.3d941cc1.png";
const ilustracaoRegistro = "/assets/good_dogg.b45a444e.png";
const registro = () => {
...
const ilustracaoLogin = "/assets/social_update.043052e6.png";
const login = () => {
  const container = document.createElement("div");
  const template = `
        <div class="main">
...
const ilustracaoRedefinir = "/assets/dog_pop.57f64908.png";
...
const coracaoDeslike = "/assets/like-pata-3.3738f0cd.png";
const coracaoPreenchido = "/assets/like-pata-2.cd5e5d65.png";
const feed = async () => {
...
const devAna = "/assets/ana.a2995aba.png";
const devPaola = "/assets/paola.ef428ad9.png";
const devThai = "/assets/thai.188049e3.png";
const tieta = "/assets/tieta.51bb1f8b.png";
const juca = "/assets/juca.179875b6.png";
const luigi = "/assets/luigi.c3374fee.png";
const iconeLinkedin = "/assets/linkedin.3e907258.png";
const iconeGitHub = "/assets/github.c0551dcc.png";
const sobre = () => {
  const container = document.createElement("div");
  const template = `
        <div class="main">
