...
const login = () => {
        ...
        <section class="bloco-login">
            <header class="form-header">
                <div class="welcome-title">
                    <h3>Bem-vindo \xE0 C&H</h3>
                    <h1>Login</h1>
                </div>
                <div class="welcome-title">
                    <label>N\xE3o tem conta?</label>
  ...
  form.addEventListener("submit", (e) => {
    ...
    login$1(username, password).then(() => {
        ...
        <form class = "form-cadastro">
            <div class="input-group">
                <div class="input-box">
                    ...
                    <input type="email" name="email" id="email" placeholder="seu endere\xE7o de e-mail" required>
                </div>
...
const db = wh(app);
const newPost = async (text, date, username, uid) => uf(sh(db, "Post"), {
  username,
  date,
  text,
  uid,
...
const getPost = async () => {
  const message = [];
  const order = dl(sh(db, "Post"), Il("date", "desc"));
...
const feed = () => {
        ...
        <form class="form-pots">
          <div class="post">
            <div class="post-text">
              ...
              <textarea class="textarea" placeholder="Qual a sua dica/d\xFAvida sobre pele ou cabelo?"></textarea>
            </div>
  ...
  const printPost = async () => {
    ...
    const templatePublish = arrayPost.map(
      (post) => {
            ...
            <section class="posts-users">
              <div class="text-and-likes">
                ...
                <div>
                  ...
                  <label class="date-and-hour">\xE0s ${post.hour}</label>
                </div> 
                <div class="like">
    ...
    arrayPost.forEach((post) => {
      ...
      if (isAuthor) {
        ...
        btnEdit.addEventListener("click", (e) => {
          e.preventDefault();
          if (window.confirm("Tem certeza que deseja editar a publica\xE7\xE3o?")) {
