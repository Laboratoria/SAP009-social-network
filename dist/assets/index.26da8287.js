...
const ilustracaoRegistro = "/SAP009-social-network/assets/good_dogg.b45a444e.png";
const registro = () => {
...
const ilustracaoRedefinir = "/SAP009-social-network/assets/dog_pop.57f64908.png";
...
const coracaoDeslike = "/SAP009-social-network/assets/like-pata-3.3738f0cd.png";
const coracaoPreenchido = "/SAP009-social-network/assets/like-pata-2.cd5e5d65.png";
const feed = async () => {
...
const devAna = "/SAP009-social-network/assets/ana.a2995aba.png";
const devPaola = "/SAP009-social-network/assets/paola.ef428ad9.png";
const devThai = "/SAP009-social-network/assets/thai.188049e3.png";
const tieta = "/SAP009-social-network/assets/tieta.51bb1f8b.png";
const juca = "/SAP009-social-network/assets/juca.179875b6.png";
const luigi = "/SAP009-social-network/assets/luigi.c3374fee.png";
const iconeLinkedin = "/SAP009-social-network/assets/linkedin.3e907258.png";
const iconeGitHub = "/SAP009-social-network/assets/github.c0551dcc.png";
const sobre = () => {
  const container = document.createElement("div");
  const template = `
        <div class="main">
