...
if (l.document && y) {
  var Ka = Ba$1();
  Ja$1 = Ka ? Ka : parseInt(Ea$1, 10) || void 0;
} else
  Ja$1 = void 0;
var La$1 = Ja$1;
function z$1(a, b2) {
...
var Xa = "closure_lm_" + (1e6 * Math.random() | 0), Ya$1 = {};
...
k$1.hb = function() {
  if (this.g) {
    ...
    this.C < b2.length && (ic$1(this), lc(this, a, b2), this.i && 4 != a && N$1(this));
  }
};
function nc$1(a, b2) {
...
function T(a, b2) {
  ...
  if (a instanceof T) {
    ...
    a && (c = String(a).match(Ec)) ? (this.h = !!b2, Gc(this, c[1] || "", true), this.s = Kc$1(c[2] || ""), this.g = Kc$1(c[3] || "", true), Hc$1(this, c[4]), this.l = Kc$1(c[5] || "", true), Jc$1(this, c[6] || "", true), this.o = Kc$1(c[7] || "")) : (this.h = !!b2, this.i = new Ic$1(null, this.h));
}
...
function Jc$1(a, b2, c) {
  b2 instanceof Ic$1 ? (a.i = b2, Qc(a.i, a.h)) : (c || (b2 = Lc$1(b2, Rc)), a.i = new Ic$1(b2, a.h));
}
function S$1(a, b2, c) {
  a.i.set(b2, c);
}
...
var Mc = /[#\/\?@]/g, Oc$1 = /[#\?:]/g, Nc = /[#\?]/g, Rc = /[#\?@]/g, Pc = /#/g;
function Ic$1(a, b2) {
  this.h = this.g = null;
  this.i = a || null;
  this.j = !!b2;
...
`;
  ...
  container.querySelector("#error-label");
  registerButton.addEventListener("click", () => {
    const email = registerEmail.value;
    const password = registerPassword.value;
    const name2 = registerName.value;
    createUserWithEmail(email, password, name2).then((isRegistered) => {
      console.log("Usu\xE1rio cadastrado!");
      window.location.replace("#login");
    }).catch((error) => {
      console.log("Usu\xE1rio n\xE3o cadastrado.");
